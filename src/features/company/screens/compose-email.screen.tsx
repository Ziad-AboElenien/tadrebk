  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <h1 className="text-2xl font-bold text-slate-900 mb-1">Compose Email</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-slate-100 p-6 sm:p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-lg font-bold text-slate-900">Your Message</h2>
                <p className="text-xs text-slate-400">This will appear in the email body</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-slate-50 border border-slate-100">
                  ...
                  <span className="text-sm text-slate-700 font-medium">{studentName}</span>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-slate-50 border border-slate-100">
                  ...
                  <span className="text-sm text-slate-700 font-medium">{internshipTitle}</span>
                </div>
              </div>
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">Live preview of the email template</p>
              </div>
            </div>

            {/* Email template preview */}
            <div className="rounded-3xl overflow-hidden shadow-[0_20px_50px_-12px_rgba(16,24,17,0.15)] border border-slate-200">
              {/* Template header */}
              <div className="bg-[#22c55e] px-8 py-6 text-center">
                <h1 className="text-white text-2xl font-bold tracking-wide">Tadreebak</h1>
              </div>
