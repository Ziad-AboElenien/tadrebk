    ...
    <div className="bg-gray-50">
      ...
      <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8">
          ...
          <aside className="hidden lg:block fixed top-24 left-[max(1rem,calc((100vw-80rem)/2+1rem))] w-[260px] max-h-[calc(100vh-9rem)] overflow-y-auto rounded-2xl bg-white p-5 shadow-sm z-40">
