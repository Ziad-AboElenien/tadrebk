    ...
    <div className="rounded-2xl bg-white/70 backdrop-blur-xl border border-white/40 shadow-[0_8px_32px_rgba(0,0,0,0.08)] overflow-hidden">
      ...
      <div className="flex items-center justify-between px-5 py-4 border-b border-white/50">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-bold text-slate-900">{currentCompany.name}</p>
            <p className="text-[11px] text-slate-400">{currentCompany.industry || 'Your company'}</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-5 py-4">
        <div className="mb-3 flex items-center justify-between">
          <p className="text-xs font-bold text-slate-700">Recent Internships</p>
        ...
        {internships.length > 0 ? (
                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        <p className="text-xs font-bold text-slate-900 truncate group-hover:text-emerald-600 transition-colors">{intern.title}</p>
                      ...
                      {desc && <p className="text-[10px] text-slate-400 mt-1 leading-relaxed line-clamp-2">{desc}...</p>}
          ...
          <p className="text-[11px] text-slate-400 text-center py-3">No internships posted yet.</p>
        )}
      </div>
...
function CompanyFallbackCard() {
  return (
    <div className="rounded-3xl bg-white shadow-2xl p-8 relative overflow-hidden group cursor-default">
      ...
      <h3 className="text-2xl font-bold text-slate-900">For Companies</h3>
