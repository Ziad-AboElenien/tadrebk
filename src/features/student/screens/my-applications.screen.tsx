...
export default function MyApplicationsScreen() {
  ...
  const fetchApplications = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const res = await applicationService.getUserApplications(user._id, { page, limit: 10 });
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      <h1 className="text-2xl font-black text-dark mb-2">My Applications</h1>
      <p className="text-sm text-gray-500 mb-8">Track the status of all your internship applications</p>
      ...
      {loading ? (
        ...
        <div className="bg-white border border-gray-100 rounded-3xl p-16 text-center shadow-sm">
          ...
          <p className="text-sm text-gray-400 mt-1">Start exploring internships and apply!</p>
